...
http.createServer((req,res)=>{
 try{
  ...
  if(!path.extname(file)){build();if(!url.pathname.endsWith('/')){res.writeHead(302,{Location:url.pathname+'/'+url.search});res.end();return;}file=path.join(file,'index.html');}
...
}).listen(4321,'127.0.0.1',()=>console.log('Portfolio preview: http://127.0.0.1:4321'));
