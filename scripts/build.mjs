...
export function build({copyAssets=true,basePath=process.env.BASE_PATH||'',outputDir=path.join(root,'dist')}={}) {
 ...
 write('',shell('Home',`<section class="home-hero"><h1>DR IVAN ISAKOV</h1><p class="home-subtitle">Immersive Technology, Haptics, Wearables, Interaction Design, Creative Technology</p></section>`));
